...
This compiles the client into a jar located at `./target/petstore-1.0.0.jar`. Note that this jar does not include any dependencies.
...
```perl
dependencies {
    compile 'com.bbd:petstore:1.0.0'
}
```
...
This will compile the client and package all dependencies into a jar located at `./target/petstore-1.0.0.jar`.
